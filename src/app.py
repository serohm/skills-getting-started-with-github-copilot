...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for competitive soccer matches and team strategy",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "rachel@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice basketball skills and prepare for school tournaments",
    ...
    "Music Ensemble": {
        "description": "Perform musical pieces and practice ensemble techniques",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "chris@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking skills and compete in debate events",
